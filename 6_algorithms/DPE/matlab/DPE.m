function [bestConfig,ex_mat,delta,sampledError] = DPE(marker,img,in_mat,minDim,... % mandatory
  ...
  t2 = tic;
	...
	% refine
  t3 = tic;
  [ex_mat ex_mats] = Refine(marker, img, in_mat, ex_mat, minDim, delta, bounds, steps, dim, photometricInvariance, method, verbose);
  if (verbose)
