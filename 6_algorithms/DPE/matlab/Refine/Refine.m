function [ex_mat ex_mats] = Refine(marker, img, in_mat, ex_mat, minDim, delta, bounds, steps, dim, photometricInvariance, method, verbose)
  
  % get 2 poses
  poses = get2Poses(in_mat, ex_mat, minDim, method);
